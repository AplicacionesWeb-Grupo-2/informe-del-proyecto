...
![](./assets/chapter-02/competitors/Ako.png)
...
![](./assets/chapter-02/competitors/Zabarburu.png)
...
![](./assets/chapter-02/competitors/Dickson.png)
...
![](./assets/chapter-02/interviews/segmento12.png)
...
![](./assets/chapter-02/interviews/segmento11.png)
...
![](./assets/chapter-02/interviews/segmento13.png)
...
![](./assets/chapter-02/interviews/segmento21.png)
...
![](./assets/chapter-02/interviews/segmento22.png)
...
![](./assets/chapter-02/interviews/segmento23.png)
...
![](./assets/chapter-02/interviews/Analisis1.png)
![](./assets/chapter-02/interviews/Analisis2.png)
![](./assets/chapter-02/interviews/Analisis3.png)
![](./assets/chapter-02/interviews/Analisis4.png)
![](./assets/chapter-02/interviews/Analisis5.png)
![](./assets/chapter-02/interviews/Analisis6.png)
...
![](./assets/chapter-02/user-personas/user1.png)
**Segmento 2:**

![](./assets/chapter-02/user-personas/user2.png)
...
![](./assets/chapter-02/journey-maps/Usermap.png)
...
![](./assets/chapter-02/empathy-maps/Empathy1.png)

**Empathy Map: 

![](./assets/chapter-02/empathy-maps/Empathy2.png)
...
![](./assets/chapter-02/eventstorming/1.png)
Gestión de cuenta:
![](./assets/chapter-02/eventstorming/2.png)
Conexión a infraestructura:
![](./assets/chapter-02/eventstorming/3.png)
Monitoreo en tiempo real:
![](./assets/chapter-02/eventstorming/4.png)
Gestión de alertas:
![](./assets/chapter-02/eventstorming/5.png)
Generación de reportes:
![](./assets/chapter-02/eventstorming/6.png)
Cumplimiento con auditoria:
![](./assets/chapter-02/eventstorming/7.png)

Add Actors and Actions: Añadir acciones realizadas por distintos actores a la hora de ejecutar el sistema 

Gestión de cuenta:

![](./assets/chapter-02/eventstorming/8.png)

Monitoreo en tiempo real:

![](./assets/chapter-02/eventstorming/9.png)

Gestión de alertas:

![](./assets/chapter-02/eventstorming/10.png)

Generación de reportes:

![](./assets/chapter-02/eventstorming/11.png)

Cumplimiento con auditoria:

![](./assets/chapter-02/eventstorming/12.png)
...
![](./assets/chapter-02/eventstorming/13.png)

Conexión a infraestructura:

![](./assets/chapter-02/eventstorming/14.png)

Monitoreo en tiempo real:

![](./assets/chapter-02/eventstorming/15.png)

Gestión de alertas:

![](./assets/chapter-02/eventstorming/16.png)

Generación de reportes:

![](./assets/chapter-02/eventstorming/17.png)

Cumplimiento con auditoria:

![](./assets/chapter-02/eventstorming/18.png)

Storytelling: Conectar de forma coherente el hilo contextual del programa

Gestión de cuenta:

![](./assets/chapter-02/eventstorming/19.png)

Conexión a infraestructura:

![](./assets/chapter-02/eventstorming/20.png)

Monitoreo en tiempo real:

![](./assets/chapter-02/eventstorming/22.png)

Gestión de alertas:

![](./assets/chapter-02/eventstorming/23.png)

Generación de reportes:

![697](./assets/chapter-02/eventstorming/24.png)

Cumplimiento con auditoria:

![](./assets/chapter-02/eventstorming/25.png)

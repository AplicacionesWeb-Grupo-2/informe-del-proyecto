...
| Validación y evaluación heurística | Cinco entrevistas registradas y tres hallazgos heurísticos documentados. |
...
| :--- | :--- | :--- |
| Tres entrevistas por cada segmento | El segundo segmento tiene dos entrevistas completas; falta una tercera entrevista real. | Grabar, publicar y documentar participante, captura, URL, timing, duración y resumen. |
...
| About-the-Product en Stream y YouTube | Existe enlace de Microsoft Stream; no se encontró enlace de YouTube, captura ni timing confirmado. | Publicar en YouTube y registrar ambos enlaces, captura, inicio y duración. |
| About-the-Team en Stream y YouTube | Existe enlace de Microsoft Stream; no se encontró enlace de YouTube ni timing confirmado. | Publicar en YouTube y registrar ambos enlaces e información temporal. |
